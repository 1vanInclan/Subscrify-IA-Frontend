...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-zinc-950 -m-8 flex text-zinc-100 overflow-x-hidden">
      {/* LADO IZQUIERDO: Branding & Showcase */}
        ...
        <div className="relative z-10 max-w-lg my-auto space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl xl:text-5xl font-extrabold tracking-tight text-white leading-[1.15]">
              Empieza a optimizar tus gastos hoy mismo.
            </h1>
            <p className="text-zinc-400 text-sm xl:text-base leading-relaxed">
              Crea tu cuenta para tomar el control de tus suscripciones, sincronizar pagos y recibir recomendaciones de ahorro automatizadas.
            </p>
          </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-zinc-400">
              Comienza a gestionar tus suscripciones con IA
            </p>
          </div>
          ...
          <div className="text-center text-xs text-zinc-400">
            <p>
              ¿Ya tienes cuenta?{' '}
              <Link href="/login" className="font-semibold text-zinc-200 hover:text-white underline underline-offset-4">
                Inicia sesión aquí
              </Link>
            </p>
          </div>
